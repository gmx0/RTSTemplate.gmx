        ...
        case __IS.TYPE_STRIP:
            if( _l_sprite[|  __IS_STREAM_IMAGE.SPRITES ] == _id && _l_sprite[|  __IS_STREAM_IMAGE.FPATH ] == _fname ){
                if( _status >= 0 ){
                    ...
                    /*
                    _l_sprite[| __IS_STREAM_IMAGE.SPRITES ] = sprite_add_ns( 
                        _l_sprite[| __IS_STREAM_IMAGE.FPATH ], sprite_get_number( _id ), 
                        _m[? "removeback" ], false,
                        sprite_get_xoffset( _id ), sprite_get_yoffset( _id ) 
                    );*/
        ...
        case __IS.TYPE_3D:
            if( _l_sprite[| __IS_STREAM_IMAGE.SPRITES ] == _id && _l_sprite[|  __IS_STREAM_IMAGE.FPATH ] == _fname ){
                if( _status >= 0 ){
                    ...
                    //_l_sprite[| __IS_STREAM_IMAGE.SPRITES ] = sprite_add_ns( _l_sprite[| __IS_STREAM_IMAGE.FPATH ], sprite_get_number( _id ), _m[? "removeback" ], false, 0, 0 );
                    sprite_delete( _id );
                }
            }
        break;
