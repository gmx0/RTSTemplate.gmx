///net_button_is_down(name, clientSocket)
/*
 * SERVER ONLY
 *
 * Checks if the button that is binded to the name is down for the 
 * given client.
 *
...
return ds_grid_get(obj_keyboard_controller.clientKeys, client, _index);
