///net_button_is_released(name, clientSocket)
/*
 * SERVER ONLY
 *
 * Checks if the button that is binded to the name is released for the 
 * given client.
 *
...
return ds_grid_get(obj_keyboard_controller.justReleased, client, _index);
